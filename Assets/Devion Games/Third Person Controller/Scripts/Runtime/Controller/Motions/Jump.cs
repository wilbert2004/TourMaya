...
namespace DevionGames
{
	public class Jump : MotionState, IControllerGrounded
	{
		...
		{
            this.m_Animator.SetFloat ("Float Value", this.m_Rigidbody.linearVelocity.y, 0.15f, Time.deltaTime);
			return true;
		}
		...
		private void StartJump ()
		{
			if (this.IsActive) {
				...
				this.m_Animator.SetFloat ("Float Value", this.m_Rigidbody.linearVelocity.y);
                float cycle = 0f;
		...
		public override bool CanStop ()
		{
			...
			return !this.m_Controller.IsGrounded && this.m_Rigidbody.linearVelocity.y < 0.01f && Time.time > jumpTime + 0.2f; 
		}
	}
}